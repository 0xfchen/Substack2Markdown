...
flowchart TD
    ...
    subgraph Scrapers ["Scraper Subpackage (scraper/scrapers/)"]
...
- [`tests/test_scraper.py`](tests/test_scraper.py): Comprehensive unit and integration test suite (82 tests).
